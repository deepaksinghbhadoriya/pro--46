...
function setup() {
 createCanvas(800,700);
  ...
  oggy.setCollider("rectangle",0,0,400,500)
  oggy.debug=false;
...
function draw() {
 ...
 if(gameState===play){
   bg.velocityX=-(4 + 10* coinScore/100);
...
oggy.collide(ground)
  ...
  fill("black")
  textSize(20)
  text("- The oggy is an artificial intelligent character",400,60);
 // text("- Press space key to jump the oggy",400,80); 
  text("- The game is infinite runner",400,90);
